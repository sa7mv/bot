...
exports.run = async(client, message, args) => {
  ...
  if(meh.get(`Banka_Hesap_${bot}_${args[0]}_${args[1]}_${args[2]}`) == null)
  {
    ...
    meh.set(`Ad_${şifre}`, args[0]);
    meh.set(`Soyad_${şifre}`, args[1]);
    ...
    meh.push(`Kart_Harcama_${hesap}_${şifre}_1`, "boş");
    meh.set(`SAHİBİ_${hesap}_${şifre}`, message.author.id);
    meh.add(`Giren_${hesap}_${şifre}`, 1);
    meh.push(`Kişiler_${hesap}_${şifre}`, `${message.author.username}:${message.author.id}`);
