...
exports.run = async(client, message, args) => {
  ...
  const silmefiltresi = meh.get(`Kart_Harcama_${kişii}_${şifre2}_1`).filter(x => x !== "boş");
  ...
  if(args[2] == "" || args[2] == null){ açıklama = "yok" } 
    ...
    meh.push(`Kart_Harcama_${hesap}_${şifre}_${sayfa}`, kişii + " IBAN:" + args[0] + " HAVALE:" + "-" + args[1] + "| \n" + "__TARİH:" + tarih + "__\n \n");
    ...
    meh.set(`Kart_Harcama_${kişii}_${şifre2}_1`, silmefiltresi);
    meh.push(`Kart_Harcama_${kişii}_${şifre2}_${sayfa2}`, hesap + " IBAN:" + meh.get(`IBAN_${hesap}_${şifre}`) + " HAVALE:" + "+" + args[1] + "\n açıklama :" + açıklama + "| \n" + "__TARİH:" + tarih + "__\n \n");
    //BİTİŞ
    } 
