...
exports.run = async(client, message, args) => {
  ...
  let date = new Date();
  const silmefiltresi = meh.get(`Kart_Harcama_${hesap}_${şifre}_1`).filter(x => x !== "boş");
  ...
  if(date.getHours() == 24)
  {
    ...
    meh.set(`Kart_Harcama_${hesap}_${şifre}_1`, silmefiltresi);
    meh.push(`Kart_Harcama_${hesap}_${şifre}_${sayfa}`, "PARA YATIRMA:" + "+" + args[0] + "| \n" + "__TARİH:" + tarih + "__\n \n");
